...
public class _Consumer {
    ...
    public static void main(String[] args) {
        ...
        greetCustomerBiConsumer.accept(maria, Boolean.FALSE);
    }
    ...
    static void greetCustomer(Customer customer) {
        System.out.println("Hello customer " + customer.customerName + ", thanks for registering phone number " + customer.customerPhoneNumber);
    }
